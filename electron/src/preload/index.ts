...
const api: TialynnApi = {
  ...
  characters: {
    ...
    // v0.21 Round J:M8 灵魂社会 — 多 character 并行 mounted API
    listMounted: () => invokeChannel(charactersListMounted, undefined as never),
    setMounted: (ids) => invokeChannel(charactersSetMounted, ids),
